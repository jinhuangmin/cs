define([
  ...
  function _(t, e, a) {
    ...
    if (t.tabs) {
      ...
      for (var c = 0; c < t.tabs.length; c++) {
        ...
        0 == c
          ? m.setAttribute("class", "etab select")
          : m.setAttribute("class", "etab"),
    ...
    !(function (t, e) {
      ...
      $(u).find(".app-tabs-nav").children().length <= 1 &&
        $(u).find(".app-tabs-nav").hide(),
      setTimeout(() => {
            ...
            return (
              $.each(e, function (t, e) {
                (a[t] = {
                  ...
                  e.offsetLeft + e.offsetWidth > i.r &&
                    (i.r = e.offsetLeft + e.offsetWidth),
                  e.offsetTop + e.offsetHeight > i.b &&
                    (i.b = e.offsetTop + e.offsetHeight),
                  e.offsetTop > i.maxt && (i.maxt = e.offsetTop),
                  e.offsetLeft > i.maxl && (i.maxl = e.offsetLeft),
                  e.offsetLeft + e.offsetWidth < i.minr &&
                    (i.minr = e.offsetLeft + e.offsetWidth),
                  e.offsetTop + e.offsetHeight < i.minb &&
                    (i.minb = e.offsetTop + e.offsetHeight);
              }),
              {
                list: a,
                max: i,
          ...
          S.length &&
            ...
            $.each(O, function (t, e) {
              ...
              (v = e.offsetLeft - Math.floor(w[t].left)),
                ...
                a &&
                  (-1 == k.indexOf(a) &&
                    (_ = S.find(".wdraggable-ui[position-sync=" + a + "]"))
                      .length &&
                    $.each(_, function (t, e) {
    ...
    return (
      ...
      (o.input_range = (function () {
        if ("input_range" == s) {
          ...
          n.setAttribute("class", "huakuai"),
            n.setAttribute("data-min", i.min),
            n.setAttribute("data-max", i.max);
      ...
      (o.image = (function () {
        if ("image" == s) {
          ...
          o.setAttribute("class", "uiSetImage"),
            (o.innerHTML = "替换图片"),
            (o.onclick = i.fun);
          var d = document.createElement("input");
          d.setAttribute("class", "imageInput"),
            (d.value = e),
            (d.onkeyup = i.fun),
            r.appendChild(d),
            r.appendChild(o);
      ...
      (o.font = (function () {
        if ("font" == s) {
          ...
          ("700" != e.fontWeight && "bold" != e.fontWeight) ||
            (t[0] += " select"),
            -1 != e.textDecoration &&
              -1 != e.textDecoration.indexOf("line-through") &&
              (t[1] += " select"),
            e.whiteSpace &&
              -1 != e.whiteSpace.indexOf("pre-wrap") &&
              (t[2] += " select"),
            ("left" != e.align &&
              "start" != e.align &&
              "flex-start" != e.align) ||
            ...
            ("right" != e.align && "flex-end" != e.align) ||
              (t[5] += " select");
          for (var l = 0; l < 6; l++)
            if (
              (1 != l || -1 != e.textDecoration) &&
              (2 != l || e.whiteSpace)
            ) {
              var r = document.createElement("span");
      ...
      (o.select = (function () {
        if ("select" == s) {
          ...
          var r = document.createElement("input");
          r.setAttribute("class", "setinput select-input"),
      ...
      (o.tip = (function () {
        if ("tip" == s) {
          ...
          e.setAttribute("class", "textarea_tip"),
            (e.innerHTML = "<i>&#xe6e8;</i>" + i.val),
            c.appendChild(e);
        }
      })()),
      (o.textarea = (function () {
        if ("textarea" == s) {
          ...
          if (
            ...
            var e = document.createElement("div");
            e.setAttribute("class", "textarea_tip"),
              (e.innerHTML = "<i>&#xe6e8;</i>" + i.tip),
              c.appendChild(e);
          }
          var a = document.createElement("textarea");
          (a = document.createElement("textarea")).setAttribute(
            "class",
            "tarea"
          ),
            (a.value = i.val),
              ...
              t.item(d, function (t) {
                ...
                $.each(t, function (t, a) {
                  var i = d[t] || {
                    ...
                    sale30: "008",
                    tagpSrc:
                      "https://img.alicdn.com/imgextra/i3/1867852664/O1CN013Jfjdx1VY9cKg0xy8_!!1867852664.png",
                    subpSrc1:
                      "https://img.alicdn.com/imgextra/i4/1867852664/O1CN011YYUFL1VY9cI6Pne2_!!1867852664.png",
                  };
                  (i.itemId = a.itemId),
                  ...
                  e.length &&
                    ((l = i.app),
                    (o = l.attr("data-config")
                      ? JSON.parse(l.attr("data-config"))
                      : {}),
                    (d = o.items),
      ...
      (o.slider = (function () {
        if ("slider" == s) {
          setTimeout(function () {
            ...
            try {
              n.create(t[0], {
                ...
                onFilter: function (t) {},
                onUpdate: function (t) {
                  let a = e.attr("data-config")
                      ? JSON.parse(e.attr("data-config"))
                      : {},
                    i = a.slider,
                    n = t.newIndex,
                    s = t.oldIndex,
          ...
          function h(i, n) {
            click_key = n;
            var s = (i = i || {}).customContent
                ? JSON.stringify(i.customContent)
                : "",
              o = $(".epr_bo_box"),
              c = {
                name: "显示",
              ...
              setTimeout(function () {
                ...
                if (i && t >= 0) {
                  ...
                  a.PagStyle_obj[0].style &&
                    a.PagStyle_obj[0].style.bgColor &&
                    (s = a.PagStyle_obj[0].style.bgColor),
                    a.PagStyle_obj[0].style &&
            ...
            (C.onclick = function () {
              var t = a.slider.push({
                ...
                i =
                  ...
                  (t - 1) +
                  '" href="" onclick="return false"><img /></a>';
              try {
                a.PagStyle_obj[1].content[t - 1] ||
                  (a.PagStyle_obj[1].content[t - 1] = String(t)),
                  a.PagStyle_obj[2].content[t - 1] ||
                    (a.PagStyle_obj[2].content[t - 1] = {
                      default:
                        "https://img.alicdn.com/imgextra/i2/1867852664/O1CN01NuR1il1VY9ctMEkPr_!!1867852664.jpg",
                      select:
                        "https://img.alicdn.com/imgextra/i3/1867852664/O1CN01b2Fns31VY9cxKMlzD_!!1867852664.jpg",
                    });
                var n =
                    (a.PagStyle_obj[1] &&
                      a.PagStyle_obj[1].content &&
                      a.PagStyle_obj[1].content[t - 1]) ||
                    t,
                  s =
                    (a.PagStyle_obj[2] &&
      ...
      (o.slider_tu = (function () {
        if ("slider_tu" == s) {
          ...
          function p(n, s) {
            ...
            l.empty(),
              f.setAttribute("data-key", s),
              f.appendChild(v(0, 0, o)),
              z();
          }
          f.setAttribute("class", "epr_bo_box"),
            i.hide && (c.style.display = "none");
  ...
  function x(e, a) {
    $(u).find(".irule").remove(),
      $(u).find("input[sjdz_none=true]").css("padding-right", "10px");
    ...
    $.each(l, function (t, e) {
      ...
      var a = $(e).val(),
        i = $(
          '<span class="sjdz_color irule"><i style="background:' +
            a +
            '"></i></span>'
        );
      $(e).after(i),
        ...
        $(u)
          ...
          .bind("click", function () {
            ...
            a + 235 >
              $(".pageRight")[0].offsetHeight + $(".pageRight")[0].offsetTop &&
              (a -= 265),
              (function (t, e, a, i, n) {
                t.spectrum({
                  allowEmpty: !0,
                  ...
                  $(".sp-container")
                    .find(".no-color")
                    .click(function () {
                      t.parents(".colors").find(".c").length <= 1
                        ? $(".colorsBox").remove()
                        : t.parents(".c").remove(),
                        $(".sp-container").remove(),
                        $(".sp_containerBG").remove();
  ...
  function y(t, e) {
    for (
      var a = "left" == e ? t.offsetLeft : t.offsetTop, i = t.offsetParent;
      null !== i;
        ...
        controls: [
          [
            ...
            },
            {
              ...
              fun: function () {
                // 发生更改的是什么 图片地址|链接网址
                const targetEle = $(this).attr("class");
                const value = $(this).val() || "";
                // 链接网址更改
                if (targetEle === "imageHref") {
                  console.log("href change")
                  a.this.find("a").attr("href", value);
                  i && i[3] ? (n[i[3]] = value) : (n.href = value);
                  e.attr("data-config", JSON.stringify(n));
                }
                // 图片地址更改
                if (targetEle === "imageInput") {
                  ...
                  c.attr("data-prev", '{"W":' + d + ',"H":' + f + "}"),
                    value &&
                      value != s &&
                      (a.this.find("img").attr("src", value),
                      $(this)
                        .parents(".ui-image-rot")
                        .find("img")
                        .attr("src", value),
                      N(value, function (t, s) {
                        i && i[0]
                          ? ((n[i[0]] = value), (n[i[1]] = t), (n[i[2]] = s))
                          : ((n.pSrc = value), (n.width = t), (n.height = s)),
                          a.this.css({
                            width: t + "px",
                            height: s + "px",
                          }),
                ...
                // 替换图片按钮,唤起图片选择面板.选择图片后执行回调,返回图片地址
                if (targetEle === "uiSetImage") {
            ...
            },
            {
              ...
              fun: function () {
                // 表单数据改变的回调, 更新 css 与 data-config
                var t = $(this).val();
                n.borderRadius = t;
                c.css("border-radius", t + "px");
                e.attr("data-config", JSON.stringify(n));
              },
            },
            {
  ...
  g.apwx_jdjs = function (t, e) {
    var a = t.attr("data-config") ? JSON.parse(t.attr("data-config")) : {},
      ...
      d =
        (Math.floor(
          (e.this[0].offsetWidth < e.this[0].offsetHeight
            ? e.this[0].offsetWidth
            : e.this[0].offsetHeight) / 2
        ),
    ...
    (c = o
      ? [
          ...
          },
          {
            ...
            min: -360,
            max: 360,
            val: i.attr("style").indexOf("rotate(")
              ? i.attr("style").split("rotate(")[1].split("deg)")[0]
              : 0,
            fun: function () {
              var e = $(this).val();
      ...
      : [
          {
            ...
            fun: function () {
              ...
              (a.dsj_show = e),
                4 == e &&
                  (t
                    .children("span[data-child-type=d]")
                    .css("visibility", "visible"),
                  t
                    .children("span[data-child-type=h]")
                    .css("visibility", "visible"),
                  t
                    .children("span[data-child-type=m]")
                    .css("visibility", "visible"),
                  t
                    .children("span[data-child-type=s]")
                    .css("visibility", "visible")),
                3 == e &&
                  (t
                    .children("span[data-child-type=d]")
              ...
              fun: function () {
                var e = $(this).val(),
                  a = $(this).attr("data-video")
                    ? JSON.parse($(this).attr("data-video"))
                    : null,
                  n = t.html();
            ...
            },
            {
              ...
              fun: function () {
                var e = $(this).data().value,
                  a = t.html();
                e.indexOf("video_") >= 0
                  ? $(u).find("._videoEndTu_").show()
                  : $(u).find("._videoEndTu_").hide(),
                  (i.autoPlay = e),
                  t.attr("data-config", JSON.stringify(i)),
                  "video_false" == e && (e = !1),
                  e
                    ? t.empty().append($(a).attr("autoplay", e))
                    : t.empty().append($(a).removeAttr("autoplay")),
                  r.set();
              },
            },
            {
            ...
            },
            {
              ...
              fun: function () {
                var e = $(this).val(),
                  a = t.html();
                e
                  ? t.empty().append($(a).attr("loop", e))
                  : t.empty().append($(a).removeAttr("loop")),
                  (i.videoLoop = e),
                  t.attr("data-config", JSON.stringify(i)),
                  r.set();
              },
            },
            {
              ...
              fun: function () {
                var e = $(this).val(),
                  a = t.html();
                e
                  ? t.empty().append($(a).attr("controls", e))
                  : t.empty().append($(a).removeAttr("controls")),
                  (i.videoControls = e),
                  t.attr("data-config", JSON.stringify(i)),
                  r.set();
              },
            },
            {
              ...
              fun: function () {
                var e = $(this).val(),
                  a = t.html();
                e
                  ? t.empty().append($(a).removeAttr("muted"))
                  : t.empty().append($(a).attr("muted", e)),
                  (i.videoMuted = e),
                  t.attr("data-config", JSON.stringify(i)),
                  r.set();
              },
  ...
  g.apwx_jnbo = function (e, a, i) {
    ...
    try {
      d > 0 &&
        (f.hasClass("bo_showsPagination") ||
          (f = e.children(".bo_showsPagination")),
        (1 != d && 2 != d) ||
    ...
    if (
      ...
      if (
          ...
          p.push(
            {
              ...
              rule: "sjdz_px",
              val:
                s.PagStyle_obj[0].style && s.PagStyle_obj[0].style.fontSize
                  ? s.PagStyle_obj[0].style.fontSize
                  : 16,
              fun: function () {
            ...
            },
            {
              ...
              val: s.PagStyle_obj[0].style
                ? s.PagStyle_obj[0].style.bgColor
          ...
          p.push({
            ...
            fun: function () {
              ...
              (s.PagPos = a),
                (1 != a && 2 != a) ||
                  ...
                  c > 0 &&
                    f
                      ...
                      .css(
                        "padding",
                        +s.PagStyle_obj[c].style.partial + "px 0 0 0"
                      ),
                ...
                (0 != a && 3 != a && 4 != a) ||
                  ...
                  c > 0 &&
                    f
                      ...
                      .css(
                        "padding",
                        "0 0 0 " + s.PagStyle_obj[c].style.partial + "px"
                      ),
                  f
                    .find(".pag-type-2")
                    .find("span")
                ...
                w(i, t[i], a),
                a > 0
                  ? f.attr("waria-locking", !0)
                  : f.removeAttr("waria-locking"),
                t ||
                  layer.msg(
                    "此模块太古老不支持此功能，请重新添加轮播模块后再试"
                  ),
                e.attr("data-config", JSON.stringify(s)),
                e.mouseenter(),
                e.mousedown(),
            ...
            c > 0 &&
              p.push({
                ...
                fun: function () {
                  ...
                  try {
                    if (
                      ((s.PagPos_obj[0].flexDirection = t),
                      e.attr("data-config", JSON.stringify(s)),
                      "row" == t)
                    ) {
                      e.children(".bo_showsPagination").find(".pagflex").css({
        ...
        var x = f.find(".pag-type-1").find("span")[0],
          y = Math.floor(
            (x.offsetWidth < x.offsetHeight ? x.offsetWidth : x.offsetHeight) /
              2
          ),
          b = s.PagStyle_obj[c];
        b
          ? (p.push({
            ...
            p.push(
              ...
              },
              {
                ...
                rule: "sjdz_px",
                val: [
                  s.PagStyle_obj[1].style.width,
                  s.PagStyle_obj[1].style.height,
                ],
                fun: function () {
                  var t = parseInt($(this).val()),
                ...
                fun: function () {
                  ...
                  f.find(".pag-type-1").find("span").css("color", t),
                    f
                      .find(".pag-type-1")
                      .find("span.select")
                      .css("color", s.PagStyle_obj[1].style.select_color),
                ...
                fun: function () {
                  ...
                  f.find(".pag-type-1").find("span").css("background-color", t),
                    f
                      ...
                      .css(
                        "background-color",
                        s.PagStyle_obj[1].style.select_bgColor
                      ),
          ...
          ? ($.each(s.slider, function (t, a) {
            ...
            p.push(
              ...
              },
              {
                ...
                rule: "sjdz_px",
                val: [
                  s.PagStyle_obj[2].style.width,
                  s.PagStyle_obj[2].style.height,
                ],
                fun: function () {
                  var t = parseInt($(this).val()),
                    a = 0 == $(this).attr("data-key") ? "width" : "height";
      ...
      function w(t, a, i) {
        e.children(".bo_edit_temp").css({
          ...
          t &&
            ...
            1 == i &&
              (e.children(".bo_edit_temp").css("left", a + "px"),
              e.children(".boSlider").css("left", a + "px")),
            3 == i &&
              (e.children(".bo_edit_temp").css("top", a + "px"),
              e.children(".boSlider").css("top", a + "px")),
            2 == i &&
              (f.css("left", e[0].offsetWidth - a + "px"),
              (s.PagPos_obj[s.PagPos].left = e[0].offsetWidth - a)),
            4 == i &&
              (f.css("top", e[0].offsetHeight - a + "px"),
              (s.PagPos_obj[s.PagPos].top = e[0].offsetHeight - a)),
            f.css(t, a + "px")),
          f.mouseenter();
      }
    }
                ...
                ("imageInput" == i &&
                  ...
                  N(n, function (t, i) {
                    a.this.hasClass("bo_prev")
                      ? ((s.prev_next.prev_pSrc = n),
                        (s.prev_next.prev_width = t),
                        (s.prev_next.prev_height = i))
                      : ((s.prev_next.next_pSrc = n),
                        (s.prev_next.next_width = t),
                        (s.prev_next.next_height = i)),
                      e.attr("data-config", JSON.stringify(s)),
                      a.this.css({
                        width: t + "px",
                        height: i + "px",
    ...
    $(h).bind("click", function () {
      if ("resizable" == $(this).attr("ck-type"))
        try {
          ...
          3 == n.PagStyle &&
            t.children(".box_pagination").children(".total").html(e);
        } catch (t) {}
    }),
      (c = [
        {
          ...
          fun: function () {
            if ($(this).hasClass("tarea"))
              ...
              (customContent = n.customContent
                ? JSON.stringify(n.customContent)
                : ""),
                a.attr(
                  "data-wh",
                  '{"w":"' +
          ...
          fun: {
            change: function (e, a) {
              var i = t.children(".box").children(".dtu"),
                n = g(e, a);
              i.length &&
                i.css("transform", "translate3d(-" + n + "px, 0px, 0px)");
            },
            image: function (t, e) {
              u(t, e);
            },
            add: function (e) {
              t.children(".box").append(
                '<a class="dtu" data-key="' +
                  e +
                  '" href="" onclick="return false"><img src=""></a>'
              );
            },
            del: function (t, e) {
              u(t, e);
  ...
  g.apwx_jxdh = function (e, a) {
    var i = e.attr("data-config") ? JSON.parse(e.attr("data-config")) : {},
      ...
      d = [
        ...
        {
          text: "缩放至0.95倍",
          value: "scale(0.95, 0.95)",
        },
        {
          text: "0.1倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(0.1, 0.1)","scale_2":"scale(1, 1)"}',
        },
        {
          text: "0.2倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(0.2, 0.2)","scale_2":"scale(1, 1)"}',
        },
        {
          text: "0.3倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(0.3, 0.3)","scale_2":"scale(1, 1)"}',
        },
        {
          text: "0.4倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(0.4, 0.4)","scale_2":"scale(1, 1)"}',
        },
        {
          text: "0.5倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(0.5, 0.5)","scale_2":"scale(1, 1)"}',
        },
        {
          text: "0.6倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(0.6, 0.6)","scale_2":"scale(1, 1)"}',
        },
        {
          text: "0.7倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(0.7, 0.7)","scale_2":"scale(1, 1)"}',
        },
        {
          text: "0.8倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(0.8, 0.8)","scale_2":"scale(1, 1)"}',
        },
        {
          text: "0.9倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(0.9, 0.9)","scale_2":"scale(1, 1)"}',
        },
        {
          text: "0.95倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(0.95, 0.95)","scale_2":"scale(1, 1)"}',
        },
        {
          text: "10倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(10, 10)","scale_2":"scale(1, 1)"}',
        },
        {
          text: "8倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(8, 8)","scale_2":"scale(1, 1)"}',
        },
        {
          text: "6倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(6, 6)","scale_2":"scale(1, 1)"}',
        },
        {
          text: "4倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(4, 4)","scale_2":"scale(1, 1)"}',
        },
        {
          text: "2倍至正常",
          value:
            '{"_scale_exp_":5,"scale_1":"scale(2, 2)","scale_2":"scale(1, 1)"}',
        },
      ],
      f = [
        {
  ...
  g.apwx_jtgif = function (t, e, a) {
    var i,
      ...
      s = n.slider,
      o =
        (n.customContent && JSON.stringify(n.customContent),
        "编辑" + t.attr("appname") || "编辑动图切换");
    i = [
      {
        name: "图片",
        ele: "slider_tu",
        ...
        fun: {
          ...
          add: function (e) {
            t.children(".box").append(
              '<span class="dtu" data-key="' + e + '"><img src=""></span>'
            );
          },
          del: function (e, i) {
            !(function (e, i) {
      ...
      p = [
          ...
          fun: function () {
            ...
            1 == e && ((n.delay = n.delay || 2e3), (n.duration = 0)),
              2 == e &&
                ((n.delay = n.delay || 2e3),
                (n.duration =
                  parseInt(n.delay) <= 500
                    ? parseInt(parseInt(n.delay) / 2)
                    : 500),
                (n.translate_Xpx = "0"),
                (n.translate_Ypx = "0"),
        ...
        },
        {
          ...
          fun: function () {
            ...
            e < 100 &&
              ((e = "100"),
              layer.msg("停留时长不能小于100"),
              n.duration >= 100 && (n.duration = 50)),
    ...
    "diy" == n.slider_change &&
      ...
      p.push({
        ...
        fun: function () {
          ...
          e._scale_exp_
            ? (n._scale_exp_ = e)
            : ((n.transform_scale = e), (n._scale_exp_ = "")),
            t.attr("data-config", JSON.stringify(n));
        },
      }),
      p.push({
  ...
  var b = [
    ...
    w = [
      ...
      },
      {
        text: "左右伸展",
        value:
          '{"_scale_exp_":1,"scale_1":"scale(0.1, 1)","scale_2":"scale(1, 1)"}',
      },
      {
        text: "右左伸展",
        value:
          '{"_scale_exp_":2,"scale_1":"scale(0.1, 1)","scale_2":"scale(1, 1)"}',
      },
      {
        text: "下上伸展",
        value:
          '{"_scale_exp_":3,"scale_1":"scale(1, 0.1)","scale_2":"scale(1, 1)"}',
      },
      {
        text: "上下伸展",
        value:
          '{"_scale_exp_":4,"scale_1":"scale(1, 0.1)","scale_2":"scale(1, 1)"}',
      },
    ],
    k = [
      {
  ...
  function C(t, e, a, i) {
    ...
    return (
      "x" == a &&
        ...
        e < 0 &&
          -e > r - t[0].offsetLeft &&
          (i && (n = !0), (c = -(r - t[0].offsetLeft - 1)))),
      "y" == a &&
        (e > 0 && l - e <= 0 && (i && (n = !0), (c = l - 1)),
        e < 0 &&
          -e > o - t[0].offsetTop &&
          (i && (n = !0), (c = -(o - t[0].offsetTop - 1)))),
  ...
  function P(t) {
    ...
    if (
      (e.length &&
        $.each(e, function (t, e) {
          e.offsetHeight + e.offsetTop > n &&
            (n = e.offsetHeight + e.offsetTop),
            e.offsetWidth + e.offsetLeft > s &&
        ...
        controls: [
          [
            {
              ...
              fun: function () {
                ...
                if (1 == t) {
                  ...
                  $(u).find(".pSrc").show(),
                    $(u).find(".customContent").hide(),
                    e.children("a.pic_href").length &&
                    e.children(".child_page").length
                      ? (e.children("a.pic_href").show(),
                        e.children(".child_page").hide())
                      : (e.children("a.pic_href").show(),
                        e.children(".child_page").hide(),
                  ...
                  (s = i.customContent ? JSON.stringify(i.customContent) : ""),
                    e.children(".popup").length
                      ? n.attr(
                          "data-wh",
                          '{"w":"' +
                            e.children(".popup").width() +
                            '","h":"' +
                            e.children(".popup").height() +
                            '"}'
                        )
                      : n.attr(
                          "data-wh",
          ...
          [
            ...
            },
            {
              ...
              ele: "select",
              val:
                j(w, JSON.stringify(i._scale_exp_)) || j(w, i.transform_scale),
              list: w,
              fun: function () {
                var t = $(this).data().value;
                t._scale_exp_
                  ? (i._scale_exp_ = t)
                  : ((i.transform_scale = t), (i._scale_exp_ = "")),
                  e.attr("data-config", JSON.stringify(i));
              },
            },
            {
          ...
          controls: [
            [
              ...
              },
              {
                name: "编辑自定义",
                ele: "textarea",
                val: a.customContent_end
                  ? JSON.stringify(a.customContent_end)
                  : "",
                fun: function () {
                  if ($(this).hasClass("tarea"))
                    if ($(this).val())
              ...
              },
              {
                ...
                fun: function () {
                  var e = $(this).val();
                  1 == e &&
                    (t.children(".popup").mouseenter(),
                    t.children(".popup").mousedown(),
                    document.onmouseup()),
                    2 == e &&
    ...
    function r(e, i) {
      ...
      let s = 1 == n.translate_type ? "left" : "top",
        r = {
          ...
          config: n,
          child_data: t.attr("data-child_data")
            ? JSON.parse(t.attr("data-child_data"))
            : "",
          pos:
            t[0].offsetWidth +
            "|" +
    ...
    function o(t, e, a) {
      ...
      return (
        $.each(t, function (t, s) {
          ...
          i +=
            "top" == a
              ? s.img_height + parseInt(n.slider_bottom)
              : s.img_width + parseInt(n.slider_right);
        }),
        parseInt(i)
      );
    }
  ...
  g.apwx_jgdtw = function (e, a) {
    ...
    var x = [
        ...
        },
        {
          ...
          fun: function () {
            ...
            t.hasClass("select")
              ? (t.removeClass("select"),
                t.parent().siblings("._set_diy_").hide())
              : (t.addClass("select"),
                t.parent().siblings("._set_diy_").fadeIn());
          },
        },
        {
          name: "显示",
          ...
          fun: function () {
            ...
            n.text != a && (n.text = a),
              t.hasClass("select")
                ? t.hasClass("align") ||
                  (t.removeClass("select"),
                  t.hasClass("fontWeight") &&
                    (e.css("font-weight", ""), (n.fontWeight = "")),
                ...
                : (t.addClass("select"),
                  t.hasClass("align") &&
                    ...
                    t.hasClass("alignRight") &&
                      ...
                      (n.align = "flex-end"))),
                  t.hasClass("fontWeight") &&
                    (e.css("font-weight", "bold"), (n.fontWeight = "bold")),
                  t.hasClass("whiteSpace") &&
                    (e
                      .children("._text_")
                      .children("pre")
    ...
    y.push(
      ...
      },
      {
        ...
        fun: function () {
          var t = $(this).val();
          (n.box.borderRadius = t),
            i.css("border-radius", t + "px"),
            e.attr("data-config", JSON.stringify(n));
        },
      }
    ),
  ...
  g.apwx_jbblb = function (e, a, i) {
    var n = e.attr("data-config") ? JSON.parse(e.attr("data-config")) : {},
      ...
      v = Math.floor(
        (a.this[0].offsetWidth < a.this[0].offsetHeight
          ? a.this[0].offsetWidth
          : a.this[0].offsetHeight) / 2
      );
    if (
      ((d =
        "none" == d
      ...
      (u = [
        {
          ...
          class: "apwx_jbblb",
          fun: function () {
            this.checked ? (n.videoShow = "true") : (n.videoShow = ""),
              e.attr("data-config", JSON.stringify(n));
          },
        },
        {
        ...
        (u = [
            ...
            fun: function () {
              ...
              if (t.hasClass("select"))
                t.hasClass("align") ||
                  (t.removeClass("select"),
                  t.hasClass("fontWeight") &&
                    e.find("." + p).css("font-weight", ""),
                  t.hasClass("textDecoration") &&
                    e.find("." + p).css("text-decoration", ""));
              else {
                ...
                t.hasClass("fontWeight") &&
                  e.find("." + p).css("font-weight", "bold"),
                  t.hasClass("textDecoration") &&
                    e.find("." + p).css("text-decoration", "line-through");
              }
              r.set();
            },
          },
          ...
          },
          {
            ...
            fun: function () {
              ...
              t.hasClass("select")
                ? (t.removeClass("select"),
                  t.parent().siblings("._border").hide())
                : (t.addClass("select"),
                  t.parent().siblings("._border").fadeIn());
            },
          },
          {
            name: "边框宽",
            ...
            fun: function () {
              var t = $(this).val();
              c.css("border-width", t + "px"),
                e.find("." + p).css("border-width", t + "px"),
                r.set();
            },
          },
          {
    ...
    var b = [
      ...
      S = [];
    $.each(b, function (t, a) {
      "visible" == e.find("." + a).css("visibility")
        ? (S[t] = !0)
        : (S[t] = !1);
    }),
      _(
                        ...
                        $.each(t, function (t, e) {
                          ...
                          if (
                            ($(e).children("pre").length &&
                              ...
                              a &&
                              l &&
                              ($(e).children("pre").text(l),
                              (n.items[s][a] = l)),
                            $(e).children("img").length &&
            ...
            [
              {
                ...
                fun: function () {
                  ...
                  t.css("font-size", e + "px"),
                    ((a = t.attr("data-config")
                      ? JSON.parse(t.attr("data-config"))
                      : {}).fontSize = e),
                    t.attr("data-config", JSON.stringify(a)),
                    r.set();
                },
                  ...
                  (a = t.attr("data-config")
                    ...
                    e.hasClass("select")
                      ? e.hasClass("align") ||
                        ...
                        e.hasClass("fontWeight") &&
                          (t.css("font-weight", ""), (a.fontWeight = "")),
  ...
  g.apwx_jautoqt = function (e, a) {
      ...
      if (t.length) {
        $("#cutyulan_canvas").remove(),
          $(u)
            .find(".ui-image-box")
            .append(
              "<canvas id='cutyulan_canvas' style='max-height:130px;max-width:222px;'></canvas>"
            );
    ...
    function s(t) {
      t
        ? ($(u).find(".uiSetImage_default").show(),
          $(u).find(".uiSetImage").css("margin-top", "0px"))
        : ($(u).find(".uiSetImage_default").hide(),
          $(u).find(".uiSetImage").css("margin-top", "45px"));
    }
    function l(t) {
      t
        ? $(u)
            .find("._imgCutEdit")
            .append("<span class='cut_tip'>未切图</span>")
        : $(u).find(".cut_tip").remove();
    }
    function o(e, a) {
      let i = !1;
      t.uptu(
    ...
    _(
      ...
      $(u)
        ...
        .find(".ui-image-hove")
        .prepend(
          "<span class='uiSetImage_default' style='display:none;'>恢复默认</span>"
        ),
      $(u)
        .find(".econtrol")
        .find(".ui-label")
      ...
      $(u)
        .find(".econtrol")
        .append("<div class='Imgcut_upload'>自动切图</div>"),
      $(u)
        .find(".econtrol")
        .append("<div class='updataImgcut'><i>&#xe646;</i>上传图片</div>"),
      $(u)
        .find(".econtrol")
        .append(
        ...
        .click(function () {
          !(function (t) {
            ...
            $("#cutImg_canvas").length ||
              $("body").append(
                "<canvas id='cutImg_canvas' style='display:none;'></canvas>"
              );
            var n = a.length,
      ...
      $(u)
        ...
        .click(function () {
          e.find(".newAddpic").attr("src")
            ...
            : i.cutpic.length
            ? $(".weexApp #appDrawHots").hasClass("select") ||
              $(".weexApp #appDrawHots").click()
            : layer.msg("亲，请先上传图片！", {
                icon: 7,
                time: 1e3,
              });
    ...
    if (($(h).unbind("click"), t)) {
      ...
      try {
        (s = t.this || $(d).find(".wdraggable-ui-selected")),
          (n = (i = s.hasClass("appovhi") ? s : s.parents(".appovhi")).data()
            .apptype),
          $(u).empty(),
          g[n](i, t, a),
          P(!0),
            ...
            controls: [
              [
                ...
                },
                {
                  ...
                  val: ["videoShow"],
                  checked:
                    "visible" == $(".pageBox .box-inner").css("overflow")
                      ? [!0]
                      : [!1],
                  ele: "checkbox",
                  class: "_page_ovhi_",
      ...
      z(),
        s.hasClass("appovhi") ||
          ($(u)
            .children(".rhd")
            .prepend(
              "<buttom class='edit_parent' data-title='编辑父元素'>&#xe635;</buttom>"
            ),
          $(u)
            .find(".edit_parent")
            .click(function () {
