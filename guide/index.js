 $(function(){
 	var navHtml='<ul id="ddmenu">'+
	        '<li class="dflli home"><a target="_blank" class="d-menu" href="https://www.cnzoom.com"><span></span><em>首页</em></a></li>'+
	        '<li class="dflli submenu"><a target="_blank" href="https://zxn.taobao.com/designer_detail.htm?&designerId=1016893" class="d-menu"><em>全部模板</em><span></span></a>'+
	        	'<ul class="xflul" style="display: none;">'+
		        	'<li class="xflli"><a target="_blank" href="https://zxn.taobao.com/designer_detail.htm?spm=a215h.7721252.1998546510.6.qvSIcI&designerId=1016893&productType=0&site=1003" class="x-menu">天猫、淘宝无线模板</a></li>'+
		        	'<li class="xflli"><a target="_blank" href="https://zxn.taobao.com/designer_detail.htm?=&designerId=1016893&productType=0&site=3&price=50-100" class="x-menu">天猫PC端模板</a></li>'+
		        	'<li class="xflli"><a target="_blank" href="https://zxn.taobao.com/designer_detail.htm?&amp;designerId=1016893&amp;productType=0&amp;site=2" class="x-menu">淘宝PC端模板</a></li>'+
		        	'<li class="xflli"><a target="_blank" href="https://zhuangxiu.alibaba.com/list.html?viewMarket=icbuzxAll&key=%E6%B2%83%E5%A7%86PC&pageSize=20&startPrice=&endPrice=&sort=sale-show&market=icbuzx" class="x-menu">Alibaba国际站模板</a></li>'+
	        	'</ul>'+
	        '</li>'+
	        '<li class="dflli"><a target="_blank" class="d-menu" href="https://www.cnzoom.com/weex"><em style="color:#ff4b44;font-weight:700;">无线定制</em></a></li>'+
	        '<li class="dflli submenu"><a target="_blank" href="https://www.cnzoom.com/3.0" class="d-menu"><em>PC装修工具</em><span></span></a>'+
	        	'<ul class="xflul" style="display: none;">'+
	        	...
	        	'</ul>'+
	        '</li>'+
	        '<li class="dflli submenu"><a target="_blank" class="d-menu"><em>其他工具</em><span></span></a>'+
	        	'<ul class="xflul" style="display: none;">'+
		        	'<li class="xflli"><a target="_blank" href="https://www.cnzoom.com/gm" class="x-menu">手机端链接转换工具</a></li>'+
		        	'<li class="xflli"><a target="_blank" href="https://www.cnzoom.com/tool/nav" class="x-menu">导航样式修改工具</a></li>'+
		        	'<li class="xflli"><a target="_blank" href="https://www.cnzoom.com/zxn/color" class="x-menu">色码值获取工具</a></li>'+
		        	'<li class="xflli"><a target="_blank" href="https://www.cnzoom.com/tool/bgfixed.html" class="x-menu">固定背景生成工具</a></li>'+
		        	'<li class="xflli"><a target="_blank" href="https://www.cnzoom.com/zxd/index.php" class="x-menu">京东装修工具</a></li>'+
	        	'</ul>'+
	        '</li>'+
